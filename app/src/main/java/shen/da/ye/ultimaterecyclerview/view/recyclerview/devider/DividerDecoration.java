...
public class DividerDecoration extends RecyclerView.ItemDecoration {
    ...
    public void onDrawOver(Canvas c, RecyclerView parent, RecyclerView.State state) {
        ...
        UltimateRecyclerViewAdapter lRecyclerViewAdapter;
        if (adapter instanceof UltimateRecyclerViewAdapter) {
            lRecyclerViewAdapter = (UltimateRecyclerViewAdapter) adapter;
        } else {
            throw new RuntimeException("the adapter must be UltimateRecyclerViewAdapter");
        }
